...
set types to {"mobile", "iPhone", "home", "work", "main"}
set contactList to {}
set nameList to {}
set numberList to {}
repeat with i from 1 to (count allNames)
  set contactNumList to {}
  repeat with j from 1 to (count item i of allPhoneLabels)
	  ...
	  set end of contactNumList to item j of item i of allPhoneNumbers
	end if
  end repeat
  if count of contactNumList is not 0
  	set contact_name to item i of allNames
  	set end of nameList to contact_name
  	set end of nameList to "%^&"
  	set end of numberList to contactNumList
  	set end of numberList to "%^&"
