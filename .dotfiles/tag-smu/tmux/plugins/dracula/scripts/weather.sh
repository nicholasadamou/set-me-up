...
# A script for gathering current location and weather at location
# This script is then called in the dracula.tmux program

# load_request_params() tests if rate limit hit
# We only test last request because of redundancy
load_request_params()
{
